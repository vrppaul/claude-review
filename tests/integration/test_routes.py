...
async def test_submit_triggers_shutdown_signal(client: AsyncClient, server_state: ServerState) -> None:
    ...
    await client.post(
        ...
        json={
            "comments": [
                {"file": "x.py", "side": "new", "severity": "note", "start_line": 1, "end_line": 1, "body": "note"}
            ]
        },
    )
...
async def test_submit_stores_result_in_state(client: AsyncClient, server_state: ServerState) -> None:
    ...
    await client.post(
        ...
        json={
            "comments": [
                {"file": "x.py", "side": "new", "severity": "note", "start_line": 1, "end_line": 1, "body": "fix this"}
            ]
        },
    )
...
async def test_submit_rejects_invalid_comment(client: AsyncClient) -> None:
    ...
    response = await client.post(
        ...
        json={
            "comments": [
                {"file": "x.py", "side": "new", "severity": "note", "start_line": 1, "end_line": 1, "body": ""}
            ]
        },
    )
    ...
    response = await client.post(
        ...
        json={
            "comments": [
                {"file": "x.py", "side": "new", "severity": "note", "start_line": 10, "end_line": 5, "body": "note"}
            ]
        },
    )
    assert response.status_code == 422
    ...
    response = await client.post(
        ...
        json={
            "comments": [
                {"file": "x.py", "side": "new", "severity": "note", "start_line": 0, "end_line": 1, "body": "note"}
            ]
        },
    )
    assert response.status_code == 422
